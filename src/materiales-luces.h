...
class TexturaBeethoven : public Textura { //ejercicio adicional pr3
   public: TexturaBeethoven(const std::string &nom, const bool horizontal);
  
};

class TexturaBeethovenDiagonal : public Textura { //ejercicio adicional pr3
   public: TexturaBeethovenDiagonal(const std::string &nom, const bool horizontal);
  
};

class TexturaTriangulo : public Textura { //ejercicio adicional pr3
   public: TexturaTriangulo(const std::string &nom);
